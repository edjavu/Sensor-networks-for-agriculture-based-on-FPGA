...
$(MEM_1)_END := 0x0403f3ff
$(MEM_1)_SPAN := 0x0001f400
$(MEM_1)_HIERARCHICAL_PATH := SRAM2
$(MEM_1)_WIDTH := 128
$(MEM_1)_HEX_DATA_WIDTH := 128
$(MEM_1)_ENDIANNESS := --little-endian-mem
$(MEM_1)_CREATE_LANES := 0

.PHONY: SRAM2
SRAM2: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
