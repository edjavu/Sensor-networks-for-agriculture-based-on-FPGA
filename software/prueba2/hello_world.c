...
int main()
{
	...
	//Valores iniciales
	IOWR(memoria,0x000,25);
	IOWR(memoria,0x001,76);
	IOWR(memoria,0x002,45);
	IOWR(memoria,0x003,44);
	...
	while (1){
		...
		//printf("El valor de la humedad_suelo es --> %d Porciento \n",humedad_suelo);
		//printf("El valor de la humedad_aire es --> %d Porciento \n",humedad_aire);
		//printf("El valor de la temperatura es --> %d  \n",temperatura);
